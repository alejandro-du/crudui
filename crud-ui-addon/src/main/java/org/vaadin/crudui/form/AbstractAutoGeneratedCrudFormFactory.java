 ...
 */
public abstract class AbstractAutoGeneratedCrudFormFactory<BEAN_TYPE> extends AbstractCrudFormFactory<BEAN_TYPE> {
    ...
    protected Binder<BEAN_TYPE> binder;

    public AbstractAutoGeneratedCrudFormFactory(Class<BEAN_TYPE> beanType) {
        super(beanType);
    ...
    protected List<HasValueAndElement> buildFields(CrudOperation operation, BEAN_TYPE bean, boolean readOnly) {
        ...
        Map<String, Property<BEAN_TYPE, ?>> propertiesMap = getConfiguration(operation).getPropertiesMap();
        propertiesMap.forEach((propertyName, property) -> {
            try {
                ...
                throw new RuntimeException("Error creating Field for property " + beanType.getName() + "." + property,
                        e);
            }
        });
    ...
    protected HasValueAndElement buildField(Property<BEAN_TYPE, ?> property)
    ...
    private void configureField(HasValue field, Property<BEAN_TYPE, ?> property, boolean readOnly) {
    ...
    protected void bindField(HasValue field, Property<BEAN_TYPE, ?> property, String propertyName) {
    ...
    protected Binder<BEAN_TYPE> buildBinder(CrudOperation operation, BEAN_TYPE bean) {
        Binder<BEAN_TYPE> binder;
    ...
    protected Button buildOperationButton(CrudOperation operation, BEAN_TYPE beanType,
    ...
    protected Component buildFooter(CrudOperation operation, BEAN_TYPE beanType,
