...
public abstract class AbstractAutoGeneratedCrudFormFactory<T> extends AbstractCrudFormFactory<T> {
    ...
    protected List<String> discoverProperties() {
        try {
            ...
            return descriptors.stream().filter(d -> !d.getName().equals("class")).map(d -> d.getName())
            ...
            try {
                ...
                if (propertyType != null) {
                    ...
                    if (field != null) {
                        ...
                        FieldCreationListener creationListener = configuration.getFieldCreationListeners()
                                .get(property);
                ...
                } else if (configuration.getPropertyTypes().containsKey(property)) {
                    propertyType = configuration.getPropertyTypes().get(property);
                    HasValueAndElement field = buildField(configuration, property, propertyType, domainObject);
    ...
    protected HasValueAndElement buildField(CrudFormConfiguration configuration, String property, Class<?> propertyType,
    ...
    private void configureField(HasValue field, String property, String fieldCaption, boolean readOnly,
            CrudFormConfiguration configuration) {
    ...
    protected void bindField(HasValue field, String property, Class<?> propertyType,
        ...
        if(configuration.getGetters().containsKey(property) && configuration.getSetters().containsKey(property)){
           ValueProvider<?, ?> valueProvider = configuration.getGetters().get(property);
           Setter<?, ?> setter = configuration.getSetters().get(property);
          if(Objects.nonNull(setter)){
            bindingBuilder.bind(valueProvider, setter);
          } else{
            bindingBuilder.bindReadOnly(valueProvider);
          }
          return;
        }
