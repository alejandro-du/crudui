...
public class Crud<B> extends Composite<VerticalLayout> {
    ...
    /**
     * Overrides the default layout implementation with a fluent API.
     *
     * @param crudLayout The custom layout
     * @return This Crud instance for chaining
     */
    public Crud<B> layout(CrudLayout<B> crudLayout) {
    ...
    /**
     * Overrides the default form factory with a fluent API.
     *
     * @param formFactory The custom form factory
     * @return This Crud instance for chaining
     */
    public Crud<B> form(CrudFormFactory<B> formFactory) {
    ...
    public AutoGeneratedFormFactory<B> getCrudFormFactory() {
        return formFactory instanceof AutoGeneratedFormFactory ? (AutoGeneratedFormFactory<B>) formFactory : null;
    }
