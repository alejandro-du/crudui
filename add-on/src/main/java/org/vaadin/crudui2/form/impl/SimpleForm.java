...
public class SimpleForm<B> extends CustomField<B> implements CrudForm<B, CustomField<B>> {

	private Binder<B> binder;
	private FormLayout formLayout;

	public SimpleForm(Class<B> beanType) {
		this(beanType, false);
	}

	public SimpleForm(Class<B> domainType, boolean useBeanValidation) {
